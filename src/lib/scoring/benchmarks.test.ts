...
describe('getBenchmark', () => {
  ...
  it('returns correct data for Level 1', () => {
    ...
    expect(b.arrPerEmployee).toBe('€200–400K')
...
describe('getNextLevelThreshold', () => {
  ...
  it('L3 → null (no next level)', () => expect(getNextLevelThreshold(3)).toBeNull())
})
